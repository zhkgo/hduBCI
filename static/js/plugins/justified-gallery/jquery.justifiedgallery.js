...
(function($){
   ...
   $.fn.justifiedGallery = function(options){
		...
		function startProcess(cont, images, settings){
			//FadeOut the loading image and FadeIn the img after their loading
		...
		function processesImages($, cont, images, lastRowWidth, settings){	
			...
			//last row----------------------
			//now we have all the img index loaded in the row arra
			...
			//fade in the img that we have changed and need to be reloaded
